...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xl">
        <a class="navbar-brand block" target="_blank" href="/fr/kbk"><span class="h1 font-bold">KooBooK</span></a>
        <section class="m-b-lg">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    <input id="email" type="email" class="form-control rounded input-lg text-center no-border"
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    <input id="password" type="password" class="form-control rounded input-lg text-center no-border"
                ...
                <button type="submit" class="btn btn-lg btn-warning lt b-white b-2x btn-block btn-rounded"><i
                            class="icon-arrow-right pull-right"></i><span class="m-r-n-lg">Sign in</span></button>
                <div class="text-center m-t m-b"><a href="{{ route('password.request') }}">

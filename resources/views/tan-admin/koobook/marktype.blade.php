        ...
        <section class="panel panel-default">
           <div class="row">
               <div class="col-sm-6">
                       ...
                       <table class="table table-striped b-t b-light">
                           ...
                           @forelse($marks as $mark)
                               <tr>
                                   ...
                                   <td>
                                       <a href="/ad/show/role/{{base64_encode($mark->id)}}">{{$mark->display_name}}</a>
                                   </td>
                                   <td>{{$mark->name}}</td>
                                   ...
                                   <td>
                                       <div class="doc-buttons">
                                           <a href="/ad/show/role/{{base64_encode($mark->id)}}">
                                               <i class="fa fa-edit text-primary-lter"> 编辑</i>
                                           </a>
                                           <a href="#" class="oper-del" data-id="{{base64_encode($mark->id)}}"
                                              data-name="{{$mark->display_name}}" data-url="/ad/destroy/role"><i
                                                       class="fa fa-trash-o text-primary-lter"> 删除</i></a>
                                           <a href="/ad/dispatch/auth/{{base64_encode($mark->id)}}">
                   ...
                   @include('tan-admin.partials.pagination' , ['paginator' => $marks])
               </div>
               <div class="col-sm-6">
                   <div class="row wrapper">
                       <div class="col-sm-12 m-b-xs">
